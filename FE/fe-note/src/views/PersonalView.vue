...
export default {
  setup() {
    ...
    const currPersonalGroupID = computed(() => store.getters.computedPersonalGroupID);
    ...
    const fetchChatHistory = async () => {
      try {
        const res = await fetch("http://localhost:3000/api/personalchat?where[PersonalID][equals]=" + currPersonalGroupID.value, {
          method: "GET",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
